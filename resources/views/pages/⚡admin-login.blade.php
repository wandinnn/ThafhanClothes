...
<div class="min-h-[80vh] flex items-center justify-center">
    <div class="w-full max-w-md animate-fade-up">
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-sm text-[#4F252E]">Masuk ke panel admin</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8">
            <form wire:submit="login" class="space-y-5">
                ...
                <button type="submit"
                        class="w-full bg-accent hover:bg-secondary text-[#4F252E] font-semibold py-2.5 px-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 text-sm">
                    Masuk
                </button>
            </form>
        </div>
        ...
        <p class="mt-6 text-center">
            <a href="{{ route('home') }}" class="text-sm text-[#4F252E] hover:text-accent transition-colors inline-flex items-center gap-1">
